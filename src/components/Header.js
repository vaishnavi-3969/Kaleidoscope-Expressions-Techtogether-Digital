        ...
        {isSidebarOpen && (
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/collections" className="flex items-center px-6 py-2 text-gray-300 hover:text-white">
                  <FaRegNewspaper className="w-5 h-5 mr-2" />
                  Collections
                </Link>
              </li>
              ...
              <li>
                <Link to="/favorites" className="flex items-center px-6 py-2 text-gray-300 hover:text-white">
